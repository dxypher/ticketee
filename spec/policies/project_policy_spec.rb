...
describe ProjectPolicy do
  ...
  context 'policy_scope' do
    ...
    it "doesn't includd projects a user is not allowed to view" do
      expect(subject).to be_empty
    end

    it 'includes all projects for admins' do
      user.admin = true
      expect(subject).to include project
    end
  end
  ...
  permissions :show? do
    ...
    it "it doesn't allow users assigned to other projects" do
